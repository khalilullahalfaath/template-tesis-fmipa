...
\inputChapter{contents/chapter-4/chapter-4}

\proposalContent{
    \inputChapter{contents/chapter-5/chapter-5-proposal}
}

% --- Bab 5 s.d Selesai ---
\thesisContent{
    \inputChapter{contents/chapter-5/chapter-5}
    \inputChapter{contents/chapter-6/chapter-6}
    \inputChapter{contents/chapter-7/chapter-7}
}
